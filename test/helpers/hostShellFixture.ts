...
export function getDefaultTestShellExecutable(): string {
  return getNativeHostShellFixture().executable;
}
...
export function buildProjectMemoryWriteCommand(
  shell: HostShellFixture,
  content: string,
): string {
