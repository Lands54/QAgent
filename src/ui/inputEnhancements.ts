...
const STATIC_COMPLETIONS: CompletionEntry[] = [
  ...
  { value: "/memory list", description: "列出当前工位可见的 memory", category: "slash", featured: true },
  ...
  { value: "/workline status", description: "查看当前工位状态", category: "slash", featured: true },
  { value: "/workline list", description: "列出所有工位", category: "slash", featured: true },
  { value: "/workline new ", displayValue: "/workline new <name>", description: "新建并切换到工位", category: "slash", featured: true },
  { value: "/workline switch ", displayValue: "/workline switch <worklineId|name>", description: "切换到某个工位", category: "slash" },
  { value: "/workline next", description: "切换到下一个工位", category: "slash" },
  { value: "/workline prev", description: "切换到上一个工位", category: "slash" },
  { value: "/workline detach", description: "让当前工位脱离书签", category: "slash" },
  { value: "/workline merge ", displayValue: "/workline merge <sourceWorkline>", description: "合并另一条工位的摘要资产", category: "slash" },
  ...
  { value: "/bookmark switch ", displayValue: "/bookmark switch <name>", description: "让当前工位切到某个书签", category: "slash" },
  ...
  { value: "/clear", description: "清空当前工位的 UI 消息", category: "slash" },
